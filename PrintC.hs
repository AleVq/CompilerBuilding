...
instance Print Decl where
  prt i e = case e of
    ...
    Dfun basictype id parameters compstmt -> prPrec i 0 (concatD [prt 0 basictype, prt 0 id, doc (showString "("), prt 0 parameters, doc (showString ")"), prt 0 compstmt])
  prtList _ [] = (concatD [])
...
instance Print CompStmt where
  prt i e = case e of
    CompStmt1 compstmtnocolon -> prPrec i 0 (concatD [prt 0 compstmtnocolon, doc (showString ";")])
    CompStmtCompStmtNocolon compstmtnocolon -> prPrec i 0 (concatD [prt 0 compstmtnocolon])

instance Print CompStmtNocolon where
  prt i e = case e of
...
instance Print SelectionStmt where
  prt i e = case e of
    ...
    IfElse rexpr stmt1 stmt2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 rexpr, doc (showString ")"), prt 0 stmt1, doc (showString "else"), prt 0 stmt2])
...
instance Print IterStmt where
  prt i e = case e of
    ...
    DoWhile stmt rexpr -> prPrec i 0 (concatD [doc (showString "do"), prt 0 stmt, doc (showString "while"), doc (showString "("), prt 0 rexpr, doc (showString ")"), doc (showString ";")])
    For stmt1 rexpr stmt2 stmt3 -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 stmt1, doc (showString ";"), prt 0 rexpr, doc (showString ";"), prt 0 stmt2, doc (showString ")"), prt 0 stmt3])
