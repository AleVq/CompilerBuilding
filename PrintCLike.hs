...
instance Print RExpr where
  prt i e = case e of
    ...
    Div rexpr1 rexpr2 -> prPrec i 8 (concatD [prt 8 rexpr1, doc (showString "/"), prt 9 rexpr2])
...
instance Print Decl where
  prt i e = case e of
    DvarCInit typespec vardeclinits -> prPrec i 0 (concatD [prt 0 typespec, prt 0 vardeclinits, doc (showString ";")])
    Dfun basictype id parameters stmtdecls -> prPrec i 0 (concatD [prt 0 basictype, prt 0 id, doc (showString "("), prt 0 parameters, doc (showString ")"), prt 0 stmtdecls])
  prtList _ [] = (concatD [])
...
instance Print CompoundType where
  prt i e = case e of
    ArrDef typespec n -> prPrec i 0 (concatD [prt 0 typespec, doc (showString "["), prt 0 n, doc (showString "]")])
    ArrUnDef typespec -> prPrec i 0 (concatD [prt 0 typespec, doc (showString "["), doc (showString "]")])
    Pointer typespec -> prPrec i 0 (concatD [prt 0 typespec, doc (showString "*")])

instance Print VarDeclInit where
  prt i e = case e of
    VarDeclIn id complexrexpr -> prPrec i 0 (concatD [prt 0 id, doc (showString "="), prt 0 complexrexpr])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
...
instance Print Parameter where
  prt i e = case e of
    Param modality typespec id -> prPrec i 0 (concatD [prt 0 modality, prt 0 typespec, prt 0 id])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
...
instance Print SelectionStmt where
  prt i e = case e of
    IfNoElse rexpr stmtdecls -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 rexpr, doc (showString ")"), prt 0 stmtdecls])
    IfElse rexpr stmtdecls1 stmtdecls2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 rexpr, doc (showString ")"), prt 0 stmtdecls1, doc (showString "else"), prt 0 stmtdecls2])

instance Print IterStmt where
  prt i e = case e of
    While rexpr stmtdecls -> prPrec i 0 (concatD [doc (showString "while"), doc (showString "("), prt 0 rexpr, doc (showString ")"), prt 0 stmtdecls])
    DoWhile stmtdecls rexpr -> prPrec i 0 (concatD [doc (showString "do"), prt 0 stmtdecls, doc (showString "while"), doc (showString "("), prt 0 rexpr, doc (showString ")"), doc (showString ";")])
    For stmt1 rexpr stmt2 stmtdecls -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 stmt1, doc (showString ";"), prt 0 rexpr, doc (showString ";"), prt 0 stmt2, doc (showString ")"), prt 0 stmtdecls])
